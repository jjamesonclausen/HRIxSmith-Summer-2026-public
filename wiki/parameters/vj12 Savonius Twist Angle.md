...
- Other cited optima include `30°` for one two-blade case and `105°` for a case with end plates, showing that the best twist angle depends on the rest of the rotor configuration. (source: sources/vj12.md)
- The review explains the benefit as a redistribution of useful aerodynamic force toward the blade tip and across the rotation, which can improve both `Cp` and torque behavior. (source: sources/vj12.md)
