...
Original caption: Fig. 16. The variation of torque and time of CRVAWT under different included angles. [Source](../../sources/vj8.md)
...
- The response-surface optimum also selects `0°` included angle. (source: sources/vj8.md)
