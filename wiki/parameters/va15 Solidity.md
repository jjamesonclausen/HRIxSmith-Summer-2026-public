...
- That startup gain comes at the expense of lower peak power output, so the source frames solidity as a startup versus peak-`Cp` tradeoff. (source: sources/va15.md)
