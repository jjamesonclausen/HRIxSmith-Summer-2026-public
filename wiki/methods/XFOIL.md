...
- The `cj9` study adds direct low-Re experimental context for `NACA0018`: it says `XFOIL` captures the overall trends reasonably well even down to `Re = 30,000`, but overestimates maximum lift coefficient relative to wind-tunnel measurements. (source: sources/cj9.md)

Related: [[PROFOIL]], [[Straight-bladed Darrieus]], [[vj24-summary]], [[vj28-summary]], [[cj9-summary]]
