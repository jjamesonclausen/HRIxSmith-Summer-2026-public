...
- In the converged case, the rotor aspect ratio is `2`, rotor radius is `0.947 m`, blade chord is `0.189 m`, and rotational speed is `299 rpm`. (source: sources/vj25.md)
- Using `h = AR * R`, the blade height is `1.894 m`; with rotor diameter `1.894 m`, the swept area is `3.588 m^2`. (source: sources/vj25.md)
- The converged design values are `cpmax = 0.464`, `sigma_cpmax = 0.4`, `lambda_cpmax = 2.96`, and second-attempt `Re = 3.8 x 10^5`. (source: sources/vj25.md)
...
Related: [[H-VAWT]], [[Multiple Stream Tube Model]], [[vj25 Rotor Aspect Ratio]], [[vj25 1-kW Twin-Bladed H-Rotor VAWT (AR 0.4)]]
