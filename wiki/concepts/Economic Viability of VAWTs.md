...
- Increasing wind speeds (e.g., ~9 m/s) can reduce break-even to ~170 years. (source: sources/n2.md)
- In the Çe¸sme case, annual building energy use fell from 172 to 118.89 kWh/m2 in the best combined-turbine case. (source: sources/va13.md)
- The va21 prototype reported `3-11.9 V`, `20-130 mA`, and `0.05-2.7 W` over the tested shaft-speed range. (source: sources/va21.md)
