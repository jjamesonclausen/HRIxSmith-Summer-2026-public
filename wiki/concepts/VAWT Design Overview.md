...
Use this page as the starting map for a VAWT design project:

- [[Urban Wind Conditions]] and [[Wind Shear]] for the operating environment. (source: sources/HRI2526.md, sources/vj3.md)
- [[VAWT]] and [[Turbine Concept Selection]] for the turbine family choice. (source: sources/vj1.md, sources/vj2.md, sources/vj4.md, sources/vj7.md, sources/vj8.md)
- [[Wind Turbine Parameters]] and [[HRI2526 Aerodynamic Design Parameters|Aerodynamic Design Parameters]] for the geometry knobs. (source: sources/HRI2526.md, sources/vj1.md, sources/vj8.md)
