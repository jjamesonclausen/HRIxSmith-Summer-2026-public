...
Wind turbine with a vertical rotor axis that can accept wind from any direction. (source: sources/n1.md, sources/g1.md)

- Suitable for urban environments with turbulent, changing wind directions. (source: sources/n1.md, sources/g1.md)
- Lower efficiency than HAWTs but easier integration in buildings. (source: sources/n1.md)
- Includes lift-based and drag-based designs. (source: sources/g1.md)
...
- No yaw system required, reducing mechanical complexity and cost. (source: sources/g2.md)
- Generator and drivetrain can be placed at ground level, improving maintenance access. (source: sources/g2.md)
- Lower noise due to lower tip speeds and ground-level machinery. (source: sources/g2.md)

Structural/operational traits:
- Simpler overall structure with fewer moving parts compared to HAWTs. (source: sources/g2.md)
- Subject to torque ripple due to cyclic angle of attack. (source: sources/g2.md)

Performance context:
- Potential efficiency comparable to HAWTs, but historically less optimized due to lower investment. (source: sources/g2.md)
