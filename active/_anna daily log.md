...
- Preliminary look at zookeeper https://zoo.dev/research/zookeeper
  - https://zoo.dev/research/zoo-cad-engine-overview (wednesday)
...
![Project Timeline (rough)](_anna daily log.assets/image-1.png)
