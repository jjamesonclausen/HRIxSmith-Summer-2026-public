...
## Initial Weighted Overall Ranking
...
| ---- | ----------------------------------------------- | ------------------- | ------------------------------------------------------------------------------------------------------------------------------------- |
| 1    | Self-starting EN0005 H-rotor Darrieus           | 4.40                | Highest overall mainly because it stays strong in both startup and efficiency, which dominate your weighting.                         |
