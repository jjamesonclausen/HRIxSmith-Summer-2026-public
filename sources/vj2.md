...
![Figure 3: (a) CAD model of the initial configuration of the proposed hybrid wind turbine (at the bottom - bearing housing and power generator); (b) simplified CAD model for CFD analysis](figure-3)
...
![Figure 4: Turbulent flow due to the Savonius rotor for an angle of attack of 30 degrees: (a) - side view; (b) - top view](figure-4)
...
![Figure 5: The shaft (in blue) occupies about 66% of the overlapping space between the two blades of the Savonius rotor](figure-5)

![Figure 6: The Savonius rotor was split in two halves that were placed on top and bottom of the hybrid wind turbine](figure-6)

![Figure 7: The influence of turbulence produced on the Darrieus blades is reduced compared with the original design; (a) - side view; (b) - top view](figure-7)
...
![Figure 8: Torque values calculated for each configuration, for one third of a complete rotation (15 degree steps)](figure-8)
